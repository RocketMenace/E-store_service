...
@shopping_cart_router.post(
    path="/add_product", status_code=status.HTTP_200_OK, response_model=Cart, summary="Add product in shopping cart.", response_description="On successful adding product, the API will respond with a 200 status code and the details of the added product in JSON format."
)
...
@shopping_cart_router.delete(path="/clear_cart", status_code=status.HTTP_204_NO_CONTENT, summary="Delete all product from cart.")
